...
@configclass
class UnitreeA1FlatEnvCfg_WMP(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "UnitreeA1FlatEnvCfg_WMP":
            self.disable_zero_weight_rewards()

@configclass
class UnitreeA1FlatEnvCfg_WMP_PLAY(UnitreeA1FlatEnvCfg_WMP):
    def __post_init__(self) -> None:
        ...
        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "UnitreeA1FlatEnvCfg_WMP_PLAY":
            self.disable_zero_weight_rewards()